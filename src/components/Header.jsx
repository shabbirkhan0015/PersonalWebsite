...
const Header = ()=>{
    ...
    return(
        ...
        <div className="hidden justify-end sm:flex space-x-3">
            <Link to="/PersonalWebsite" className="nav-link hover:text-orange-600">Home</Link>
    ...
    {isNavOpen && (
        <div className="basis-full sm:hidden bg-gray-100 flex flex-col items-center overflow-hidden space-y-2">
            <Link to="/PersonalWebsite" className="w-full block border border-transparent border-b-2 hover:bg-orange-600 hover:text-white text-center">Home</Link>
